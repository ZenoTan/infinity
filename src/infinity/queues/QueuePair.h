...
public:
  ...
  void send(infinity::memory::Buffer *buffer, uint32_t sizeInBytes,
            infinity::requests::RequestToken *requestToken = NULL);
  void send(infinity::memory::Buffer *buffer, uint64_t localOffset,
  ...
  void write(infinity::memory::Buffer *buffer,
             ...
             infinity::requests::RequestToken *requestToken = NULL);
  void write(infinity::memory::Buffer *buffer,
             infinity::memory::RegionToken *destination, uint32_t sizeInBytes,
             infinity::requests::RequestToken *requestToken = NULL);
  void write(infinity::memory::Buffer *buffer, uint64_t localOffset,
  ...
  void read(infinity::memory::Buffer *buffer,
            ...
            infinity::requests::RequestToken *requestToken = NULL);
  void read(infinity::memory::Buffer *buffer,
            infinity::memory::RegionToken *source, uint32_t sizeInBytes,
            infinity::requests::RequestToken *requestToken = NULL);
  void read(infinity::memory::Buffer *buffer, uint64_t localOffset,
...
public:
  ...
  void multiWrite(infinity::memory::Buffer **buffers, uint32_t *sizesInBytes,
                  uint64_t *localOffsets, uint32_t numberOfElements,
                  infinity::memory::RegionToken *destination,
                  uint64_t remoteOffset, OperationFlags flags,
                  infinity::requests::RequestToken *requestToken = NULL);

  void sendWithImmediate(infinity::memory::Buffer *buffer, uint64_t localOffset,
                         uint32_t sizeInBytes, uint32_t immediateValue,
                         OperationFlags flags,
                         infinity::requests::RequestToken *requestToken = NULL);

  void
  writeWithImmediate(infinity::memory::Buffer *buffer, uint64_t localOffset,
                     infinity::memory::RegionToken *destination,
...
public:
  ...
  void compareAndSwap(infinity::memory::RegionToken *destination,
                      ...
                      infinity::requests::RequestToken *requestToken = NULL);
  void compareAndSwap(infinity::memory::RegionToken *destination,
                      infinity::memory::Atomic *previousValue, uint64_t compare,
                      uint64_t swap, OperationFlags flags,
                      infinity::requests::RequestToken *requestToken = NULL);
  void fetchAndAdd(infinity::memory::RegionToken *destination, uint64_t add,
                   infinity::requests::RequestToken *requestToken = NULL);
  void fetchAndAdd(infinity::memory::RegionToken *destination,
                   infinity::memory::Atomic *previousValue, uint64_t add,
                   OperationFlags flags,
                   infinity::requests::RequestToken *requestToken = NULL);
